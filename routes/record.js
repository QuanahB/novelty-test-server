...
// THIS IS FOR THE WORD.JS SECTION
recordRoutes.route("/record/addWord").post(function (req, response) {
  let db_connect = dbo.getDb();
  let myobj = {
    word: req.body.word,
 ...
 //To Display Records for Words
 recordRoutes.route("/recordWords").get(function (req, res) {
  let db_connect = dbo.getDb("employees");
  db_connect
    .collection("words")
    .find({})
